    ...
    >
      <MDBCarouselInner>
        ...
        <MDBCarouselItem itemId="2">
          ...
          <MDBCarouselCaption>
            <h3 className="text-primary slide-info h3-responsive slide-home-title font-weight-bold text-uppercase">Khay cốc INOX 304</h3>
          </MDBCarouselCaption>
        </MDBCarouselItem>
        ...
        <MDBCarouselItem itemId="6">
          ...
          <MDBCarouselCaption>
            <h3 className="text-primary slide-info h3-responsive slide-home-title font-weight-bold text-uppercase">Mắc áo INOX 304</h3>
          </MDBCarouselCaption>
        </MDBCarouselItem>
      </MDBCarouselInner>
    </MDBCarousel>
